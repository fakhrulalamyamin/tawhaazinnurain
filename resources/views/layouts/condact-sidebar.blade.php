...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-86 border-r border-gray-500 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
        ...
        <div class="w-full h-full py-4 flex flex-col gap-2">
            ...
            <div class="w-[300px] mt-8" id="accordion-collapse" data-accordion="collapse">
                <h2 id="accordion-collapse-heading-1">
                    <button type="button" class="w-full flex items-center justify-between px-4 py-4 font-poppins font-medium text-left text-sm text-white bg-gray-300 focus:text-primary-0 rounded-xl hover:bg-[#5884B0]/90 duration-300 transition" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
